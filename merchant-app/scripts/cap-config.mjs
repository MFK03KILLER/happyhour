...
const REMOTE_URL = process.env.HH_REMOTE_URL || 'https://happyhourz.org/merchant/';
const cfg = {
  ...
  server: mode === 'remote'
    ? { url: REMOTE_URL, cleartext: false, androidScheme: 'https', iosScheme: 'capacitor' }
    : { androidScheme: 'https', iosScheme: 'capacitor' },
  plugins: {
    SplashScreen: { launchShowDuration: 1000, backgroundColor: '#0E5C5C', showSpinner: false, androidScaleType: 'CENTER_CROP' },
